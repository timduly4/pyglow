...
plt.clf()
plt.plot(ag6300, alts, 'ro-', label='630.0-nm airglow VER')
plt.plot(ag7774, alts, 'go--', label='777.4-nm airglow VER')
plt.grid()
plt.xlabel('Volume Emission Rate (VER) [ph/cm$^3$/s]')
plt.ylabel('Altitude [km]')
plt.title('Testing: Point.run_airglow()' + \
        '\n%s UT, Lat = %3.1f$^\circ$, Lon = %3.1f$^\circ$' %\
